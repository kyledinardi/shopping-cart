...
1. Open the termainal and clone the repository to your computer: `git clone git@github.com:kyledinardi/shopping-cart.git`
2. Change to the project directory: `cd shopping-cart`
3. Install packages: `npm install`
4. Create a .env file in the current directory and add this lines: `VITE_BACKEND_URL=http://localhost:3000`
5. Follow the directions to set up the [backend](https://github.com/kyledinardi/shoppin-cart-backend)
